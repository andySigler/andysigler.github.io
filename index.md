...
/*        -webkit-filter: grayscale(50%);  Safari 6.0 - 9.0 
    ...
    .sectionContent {
        margin-top: 0px !important; /* overwrite theme */
    }
    hr {
...
<div class="row t30 sectionContent">
    ...
    <div class="medium-4 columns bottomMargin">
        <a href="{{site.url}}/projects/uarm-api/"  class="wrappedLink">
            <img class="borderImg" src="{{site.url}}/images/uarm-wrapper-thumb.png" alt="">
            <span class="overlayText">uArm API</span>
        </a>
    </div>
    <div class="medium-4 columns bottomMargin">
...
<div class="matchbook sectionTitle">DIY Circuits</div>
<div class="row t30 sectionContent">
    <div class="medium-4 columns bottomMargin">
...
<div class="matchbook sectionTitle">Master's Thesis</div>
<div class="row t30 sectionContent">
...
<div class="matchbook sectionTitle">Physical Computing</div>
<div class="row t30 sectionContent">
    <div class="medium-6 columns bottomMargin">
...
<div class="matchbook sectionTitle">Web</div>
<div class="row t30 sectionContent">
<!--     <div class="medium-4 columns bottomMargin">
        <a href="{{site.url}}/projects/ml-experiments/"  class="wrappedLink">
            <img class="borderImg" src="{{site.url}}/images/placeholder.png" alt="">
            <span class="overlayText">Tensorflow Experiments</span>
        </a>
    </div> -->
    <div class="medium-6 columns bottomMargin">

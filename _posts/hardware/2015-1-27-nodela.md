...
teaser: The Roland-Modela is a discontued, but well made micro-milling machine. It's software package is terrible, so I made a simple interface for milling PCBs, and designed a new bed from delrin.
breadcrumb: false
categories:
    - hardware
tags:
